...
struct qt_meta_stringdata_AutoSavingsDialog_t {
    QByteArrayData data[5];
    char stringdata[97];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AutoSavingsDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AutoSavingsDialog_t qt_meta_stringdata_AutoSavingsDialog = {
    {
...
QT_MOC_LITERAL(4, 68, 28)
    ...
    "AutoSavingsDialog\0on_enableButton_clicked\0"
    "\0on_disableButton_clicked\0"
...
const QMetaObject AutoSavingsDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AutoSavingsDialog.data,
      qt_meta_data_AutoSavingsDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AutoSavingsDialog.stringdata))
