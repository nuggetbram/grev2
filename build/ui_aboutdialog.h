...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        versionLabel->setText(QStringLiteral("0.7.5.0-beta"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About GreenCoinX", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>GreenCoinX</b> version", 0));
        copyrightLabel->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2009-2014 The GreenCoinX Foundation", 0));
